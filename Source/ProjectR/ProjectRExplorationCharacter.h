...
#include "ProjectRExplorationCharacter.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTR_API AProjectRExplorationCharacter : public AProjectRCharacter
{
	GENERATED_BODY()
...
public:
	AProjectRExplorationCharacter(const FObjectInitializer& ObjectInitializer);
